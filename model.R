  ...
  # loop until time runs out
      while(totalSecs < blockSecs) {
        ...
        for(t in 1 : nAvaStep){
          ...
          # record vaWait and vaQuit
          vaWaits[t, tIdx + 1] = ws[t]; # next trial in vaWaits tracks updated vaWaits
          vaQuits[t, tIdx] = vaQuit;# currect trial in vaQuits tracks unupdated vaQuits
