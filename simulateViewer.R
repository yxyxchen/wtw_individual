...
ManualModel = function(para, MSPara, otherPara, cond){
  phi = para[1]
  tau = para[2]
  gamma = para[3]
  lambda = para[4]
  ...
  rewardDelays[1:240] = rep(c(2, 4, 8), 80)
  # rewardDelays[1:240] = rep(c(1.604114, 5.671536, 10.201164), 80)
  # rewardDelays[1:240] = rep(c(5, 10), 120)
  ...
  for(tIdx in 1 : 240) {
    ...
    # here stepGap meatured between At and At+1
    delta = nextReward * gamma ^ rev((1 : t)-1) - ws[1:t]
    # anything wrong with the delta here?
    # change to 1 / n 
    ws[1:t] = ws[1:t] +  delta / tIdx
  } # simulation end
